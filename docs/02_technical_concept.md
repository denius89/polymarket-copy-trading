...
Первая интеграция — Limitless через партнёрский Programmatic API. Polymarket остаётся отдельным вторым adapter-кандидатом; мультиплатформенное исполнение не входит в первый MVP.
