...
Обновление: основатель выбрал базовую настраиваемую сервисную комиссию 1%. Прежние 0,25–0,5% больше не базовая цена; сценарные примеры ниже на 0,35% сохранены только как историческая чувствительность и требуют пересчёта. Рейтинг, границы первой версии, ограничения ставки по типу исполнения и предложенная партнёрская лестница описаны в документе 09. Подписка — отдельная гипотеза; performance fee не добавляется.
...
Иллюстрация, не прогноз: при 0,35% месячный V в $200 / $1 000 / $5 000 даёт $0,70 / $3,50 / $17,50 выручки до расходов. Без данных о поддержке и удержании вывод о прибыльности невозможен. Маленький баланс сам по себе не определяет оборот; частая торговля не должна искусственно стимулироваться ради комиссии.

Исправление прошлого ответа: покупка на $100 и продажа на $100 при 1% дают $2 комиссии — 2% первоначальных $100, но 1% совокупного оборота $200.
...
Polymarket остаётся первым кандидатом благодаря исходному опыту, Limitless — самостоятельной альтернативной площадкой. Сравнение может изменить порядок, но обе интеграции одновременно не планируются. Нельзя копировать сделку между площадками только по похожему названию рынка: условия разрешения и ликвидность могут различаться.
