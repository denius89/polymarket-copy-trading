...
|---:|---|---|---|
| 01 | [Продукт и экономика](01_product_and_economics.md) | ценность, границы, выручка, метрики | рабочий; требует финального согласования цены |
...
| 09 | [Рейтинг, комиссия и партнёрская лестница](09_product_decisions_and_partner_tiers.md) | текущая ставка и альтернативный ценовой тест |
